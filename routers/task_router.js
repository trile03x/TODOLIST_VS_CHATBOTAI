...
const {createTasks,showTasks,showDetailTasks,updateTasks,deleteTasks,showDetailTaskByQuery,showTaskRun} = require("../controllers/task_controller")
const taskRouter = express.Router();
taskRouter.post("/filter", showDetailTaskByQuery);
taskRouter.post("/create", createTasks);
taskRouter.get("/show", showTasks);
taskRouter.get("/runing", showTaskRun);
